...
ax = Axis(f[1, 1]; title=latexstring("\\pi_L(H|b)\\pi_\\mathrm{Prior}(b)"), xlabel=latexstring("\\mu"), ylabel=latexstring("\\sigma^2"), xticks=1.5:1.:15.0, yticks=0.0:0.1:1.0, titlesize=32)
